...
const TAB_CONFIG: Record<keyof TabParamList, { label: string; icon: IoniconsName; iconFocused: IoniconsName; title: string }> = {
    ...
    <Tab.Navigator
      screenOptions={({ route }) => {
        ...
        return {
          ...
          headerTitleStyle: { fontWeight: '700', color: Colors.textPrimary, fontSize: Theme.fontSize.lg },
        };
      }}
    >
